...
typedef NS_ENUM(NSInteger, CNLoadingButtonAlignment) {
    CNLoadingButtonAlignmentLeft,
    CNLoadingButtonAlignmentRight,
    CNLoadingButtonAlignmentCenter,// 不显示图片和文字，只显示菊花
};

@interface CNLoadingButton : UIButton
...
//
@property(nonatomic,assign)CNLoadingButtonAlignment loadingButtonAlignment;// default left
//
